...
import com.ahkam.aicam.databinding.ActivityCameraBinding
import com.ahkam.aicam.ml.DetectQuantMetadata
...
class CameraActivity : AppCompatActivity() {
    ...
    private lateinit var model: DetectQuantMetadata
...
//    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        model = DetectQuantMetadata.newInstance(this)
    ...
    private fun reportCardPrediction2(
        score: Float,
        myLocation: RectF,
        category: String,
        ...
        val location = mapOutputCoordinates(
            RectF(locations[1], locations[0], locations[3], locations[2])
        )

//        val location = mapOutputCoordinates(
//            RectF(myLocation.left, myLocation.top, myLocation.right, myLocation.bottom)
//        )
